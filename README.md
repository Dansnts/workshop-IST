...
- [Apache Airflow Project Overview — Group Presentation](#apache-airflow-project-overview--group-presentation)
  ...
  - [⚠️ Strategic Considerations](#️-strategic-considerations)
    - [Pros:](#pros)
    - [Cons:](#cons)
  ...
  - [✅ Useful Commands](#-useful-commands)
    - [Re-initialize the database (⚠️ This will erase metadata!)](#re-initialize-the-database-️-this-will-erase-metadata)
